...
function createRemultServerCore(options, serverCoreOptions) {
    ...
    server_action_info_js_1.actionInfo.runningOnServer = true;
    ...
    var dataProvider = (0, initDataProvider_js_1.initDataProvider)(options.dataProvider);
    ...
    context_js_1.RemultAsyncLocalStorage.enable();
    {
        var allControllers = [];
        if (!options.entities)
            options.entities = tslib_1.__spreadArray([], tslib_1.__read(context_js_1.allEntities), false);
        if (options.entities)
...
var RemultServerImplementation = /** @class */ (function () {
    function RemultServerImplementation(queue, options, dataProvider, coreOptions) {
        ...
        this.withRemult = function (req, res, next) {
            _this.process(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                return tslib_1.__generator(this, function (_a) {
                    next();
                    return [2 /*return*/];
                });
    ...
    RemultServerImplementation.prototype.withRemultAsync = function (request, what) {
        ...
        return new Promise(function (resolve, error) {
            return _this.withRemult(request, undefined, function () {
                try {
    ...
    RemultServerImplementation.prototype.add = function (key, dataApiFactory, r) {
        ...
        r.route(myRoute)
            ...
            return [2 /*return*/, dataApiFactory(c).delete(res, '')];
        }); }); }))
    ...
    RemultServerImplementation.prototype.runWithRemult = function (what, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, context_js_1.withRemult)(function (remult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            var x, _a;
                            return tslib_1.__generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
    ...
    RemultServerImplementation.prototype.process = function (what) {
        ...
        return function (req, origRes) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
            var genReq, myReq, myRes;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        genReq = this.coreOptions.buildGenericRequestInfo(req);
                        if (!genReq.query) {
                            genReq.query = req['_tempQuery'];
                        }
                        if (!genReq.params)
                            genReq.params = req['_tempParams'];
                        myReq = new ExpressRequestBridgeToDataApiRequest(genReq);
                        myRes = new ExpressResponseBridgeToDataApiResponse(origRes, req);
                        return [4 /*yield*/, this.runWithRemult(function (remult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var user;
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            user = void 0;
                                            if (!this.options.getUser) return [3 /*break*/, 2];
                                        ...
                                        case 3:
                                            if (user)
                                                remult.user = user;
                                            if (!this.options.initRequest) return [3 /*break*/, 5];
                                        ...
                                        case 4:
                                            _a.sent();
                                            _a.label = 5;
                                        case 5: return [4 /*yield*/, what(remult, myReq, myRes, genReq, origRes, req)];
                                        case 6:
                                            _a.sent();
                                            return [2 /*return*/];
                                    }
...
var ExpressResponseBridgeToDataApiResponse = /** @class */ (function () {
    function ExpressResponseBridgeToDataApiResponse(r, req) {
        this.r = r;
        this.req = req;
    }
    ...
    ExpressResponseBridgeToDataApiResponse.prototype.setStatus = function (status) {
    ...
    ExpressResponseBridgeToDataApiResponse.prototype.error = function (data) {
        var _a;
        data = (0, data_api_js_1.serializeError)(data);
        console.error({
...
context_js_1.allEntities.splice(context_js_1.allEntities.indexOf(JobsInQueueEntity), 1);
