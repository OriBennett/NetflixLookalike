...
var DataProviderLiveQueryStorage = /** @class */ (function () {
    function DataProviderLiveQueryStorage(dataProvider) {
        this.dataProvider = (0, initDataProvider_js_1.initDataProvider)(dataProvider);
...
context_js_1.allEntities.splice(context_js_1.allEntities.indexOf(LiveQueryStorageEntity), 1);
