...
_Side node: if \`page\` arg is set, \`offset\` will be ignored._`,
        ...
        \`before\` this \`cursor\`.`,
            ...
            if (checkCanExist(meta.options.allowApiUpdate)) {
                ...
                root[updateResolverKey] = handleMutationWithErrors(async (dApi, response, setResult, arg1, req) => {
                    await dApi.put({
                        ...response,
                        success: (y) => {
                            currentType.query.resultProcessors.forEach((z) => z(y));
                ...
                resolversMutation[updateResolverKey] = (origItem, args, req, gqlInfo) => root[updateResolverKey](args, req, gqlInfo);
            }
            if (checkCanExist(meta.options.allowApiDelete)) {
                ...
                root[deleteResolverKey] = handleMutationWithErrors(async (dApi, response, setResult, arg1, req) => {
                    await dApi.delete({
                        ...response,
                        deleted: () => {
                ...
                resolversMutation[deleteResolverKey] = (origItem, args, req, gqlInfo) => root[deleteResolverKey](args, req, gqlInfo);
            }
            ...
            for (const f of meta.fields) {
                ...
                const ref = entities.find((i) => i.entityType === f.valueType);
