...
import { ClassHelper, Remult, allEntities, classHelpers, doTransaction, isBackend, setControllerSettings, } from './context.js';
...
export function BackendMethod(options) {
    return (target, context, descriptor) => {
        ...
        if (target.prototype !== undefined) {
            ...
            let serverAction = new myServerAction((options?.apiPrefix ? options.apiPrefix + '/' : '') + key, types, options, (args) => originalMethod.apply(undefined, args));
