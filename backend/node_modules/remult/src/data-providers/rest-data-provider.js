...
exports.liveQueryAction = exports.addFilterToUrlAndReturnTrueIfSuccessful = exports.RestDataProviderHttpProviderUsingFetch = exports.RestEntityDataProvider = exports.findOptionsFromJson = exports.findOptionsToJson = exports.RestDataProvider = void 0;
...
var RestDataProvider = /** @class */ (function () {
    function RestDataProvider(apiProvider) {
        ...
        for (var key in options.include) {
            if (Object.prototype.hasOwnProperty.call(options.include, key)) {
                ...
                if (typeof element === 'object') {
                    var rel = (0, relationInfoMember_js_1.getRelationInfo)(meta.fields.find(key).options);
                    if (rel) {
                        element = findOptionsToJson(element, new context_js_1.Remult().repo(rel.toType()).metadata);
                    }
                }
                ...
                if (key === 'where') {
                    ...
                    for (var key_1 in newInclude) {
                        if (Object.prototype.hasOwnProperty.call(newInclude, key_1)) {
                            ...
                            if (typeof element === 'object') {
                                var rel = (0, relationInfoMember_js_1.getRelationInfo)(meta.fields.find(key_1).options);
                                if (rel) {
                                    element = findOptionsFromJson(element, new context_js_1.Remult().repo(rel.toType()).metadata);
                                }
                            }
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    ...
                                    unsubscribe: function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                        var _this = this;
                                        return tslib_1.__generator(this, function (_a) {
                                            return [2 /*return*/, server_action_info_js_1.actionInfo.runActionWithoutBlockingUI(function () {
