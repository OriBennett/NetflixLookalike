...
exports.classBackendMethodsArray = exports.prepareReceivedArgs = exports.prepareArgsToSend = exports.ProgressListener = exports.BackendMethod = exports.Controller = exports.myServerAction = exports.ForbiddenError = exports.Action = void 0;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        progress_1 = server_action_info_js_1.actionInfo.startBusyWithProgress();
                        _a.label = 2;
                    case 2:
                        _a.trys.push([2, , 4, 5]);
                        return [4 /*yield*/, server_action_info_js_1.actionInfo.runActionWithoutBlockingUI(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
...
var myServerAction = /** @class */ (function (_super) {
    ...
    function myServerAction(name, types, options, originalMethod) {
        var _this = _super.call(this, name, options.queue, options.allowed) || this;
        _this.types = types;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, context_js_1.doTransaction)(remult, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                var _a, _b, err_2;
...
function BackendMethod(options) {
    ...
    return function (target, context, descriptor) {
        ...
        if (target.prototype !== undefined) {
            ...
            var serverAction_1 = new myServerAction(((options === null || options === void 0 ? void 0 : options.apiPrefix) ? options.apiPrefix + '/' : '') + key, types, options, function (args) { return originalMethod.apply(undefined, args); });
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, server_action_info_js_1.actionInfo.runActionWithoutBlockingUI(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                ...
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1: return [2 /*return*/, _a.sent()];
                            case 2: return [4 /*yield*/, originalMethod.apply(this, args)];
        ...
        if (options.paramTypes)
            types = options.paramTypes;
        var x = context_js_1.classHelpers.get(target.constructor);
        if (!x) {
            x = new context_js_1.ClassHelper();
            context_js_1.classHelpers.set(target.constructor, x);
        }
        var serverAction = {
            __register: function (reg) {
                ...
                var _loop_1 = function (constructor) {
                    ...
                    reg(controllerOptions.key +
                        ...
                        key, options ? options.queue : false, options.allowed, function (d, req, res) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                        ...
                        return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    _a.trys.push([1, 3, , 4]);
                                    remult_1 = req;
                                    return [4 /*yield*/, (0, context_js_1.doTransaction)(remult_1, function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                            var _a, repo, y, rowHelper, rows, defs, err_4, y, controllerRef, err_5;
                                            var _b, _c, _d;
                                            return tslib_1.__generator(this, function (_e) {
                                                switch (_e.label) {
                                                    case 0:
                                                        _a = d;
                                                        return [4 /*yield*/, prepareReceivedArgs(types, d.args, remult_1, remult_1.dataProvider, res)];
                                                    case 1:
                                                        _a.args = _e.sent();
                                                        if (!context_js_1.allEntities.includes(constructor)) return [3 /*break*/, 13];
                                                    ...
                                                    case 3: return [4 /*yield*/, repo.find({
                                                            where: tslib_1.__assign(tslib_1.__assign({}, repo.metadata.idMetadata.getIdFilter(d.rowInfo.id)), { $and: [repo.metadata.options.apiPrefilter] }),
                                                        })];
                                                    case 4:
                                                        rows = _e.sent();
                                                        if (rows.length != 1)
                                                        ...
                                                        y = rows[0];
                                                        return [4 /*yield*/, repo.getEntityRef(y)._updateEntityBasedOnApi(d.rowInfo.data)];
                                                    case 5:
                                                        _e.sent();
                                                        _e.label = 6;
                                                    case 6:
                ...
                try {
                    for (var _b = tslib_1.__values(x.classes.keys()), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                return tslib_1.__awaiter(this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_h) {
                        switch (_h.label) {
                            case 0:
                                args = prepareArgsToSend(types, args);
                                if (!context_js_1.allEntities.includes(target.constructor)) return [3 /*break*/, 8];
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            self_1 = this;
                            return [2 /*return*/, serverAction.doWork(args, self_1)];
...
function registerAction(target, resultMethod) {
    ...
    server_action_info_js_1.actionInfo.allActions.push(resultMethod);
}
