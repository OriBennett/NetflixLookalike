...
exports.withRemult = exports.doTransaction = exports.EventSource = exports.queryConfig = exports.Allow = exports.setControllerSettings = exports.ClassHelper = exports.classHelpers = exports.allEntities = exports.Remult = exports.isBackend = exports.RemultAsyncLocalStorage = void 0;
...
var RemultAsyncLocalStorage = /** @class */ (function () {
    ...
    RemultAsyncLocalStorage.enable = function () {
        ;
        remult_proxy_js_1.remult.remultFactory = function () {
            var r = RemultAsyncLocalStorage.instance.getRemult();
            if (r)
                return r;
            else
    ...
    RemultAsyncLocalStorage.disable = function () {
        ;
        remult_proxy_js_1.remult.resetFactory();
    };
    RemultAsyncLocalStorage.prototype.run = function (remult, callback) {
        if (this.remultObjectStorage)
            this.remultObjectStorage.run(remult, function () { return callback(remult); });
        else
            callback(remult);
    };
    RemultAsyncLocalStorage.prototype.getRemult = function () {
        if (!this.remultObjectStorage) {
...
function isBackend() {
    return server_action_info_js_1.actionInfo.runningOnServer || !remult_proxy_js_1.remult.dataProvider.isProxy;
}
...
var Remult = /** @class */ (function () {
     ...
     */
    Remult.prototype.repo = function (entity, dataProvider) {
        ...
        if (!r) {
            dpCache.set(entity, (r = new RepositoryImplementation_js_1.RepositoryImplementation(entity, this, dataProvider, (0, RepositoryImplementation_js_1.createOldEntity)(entity, this))));
        }
        return r;
    };
...
remult_proxy_js_1.RemultProxy.defaultRemultFactory = function () { return new Remult(); };
exports.allEntities = [];
...
function setControllerSettings(target, options) {
    ...
    while (true) {
        ...
        if (!helper)
            exports.classHelpers.set(r, (helper = new ClassHelper()));
...
function withRemult(callback, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.dataProvider)
        remult.dataProvider = options.dataProvider;
    var r;
    RemultAsyncLocalStorage.instance.run(remult, function () {
            ...
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = res;
                        return [4 /*yield*/, callback(remult)];
                    case 1:
