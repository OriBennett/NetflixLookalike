...
var RepositoryImplementation = /** @class */ (function () {
    ...
    RepositoryImplementation.prototype.relations = function (item) {
        ...
        return new Proxy({}, {
            get: function (target, key) {
                ...
                var rel = (0, relationInfoMember_js_1.getRelationInfo)(field.options);
                if (!rel)
                    throw Error(key + ' is not a relation');
                var repo = _this.remult.repo(rel.toType());
                var _a = _this.findOptionsBasedOnRelation(rel, field, undefined, item, repo), findOptions = _a.findOptions, returnNull = _a.returnNull, returnUndefined = _a.returnUndefined;
                    ...
                    case 5:
                        ...
                        for (key in entity) {
                            if (Object.prototype.hasOwnProperty.call(entity, key)) {
                                f = ref.fields[key];
                                if (entity[key] === undefined && (0, relationInfoMember_js_1.getRelationInfo)(f.metadata.options))
                                    continue;
                                //@ts-ignore
                                if (f)
                                    r[key] = entity[key];
    ...
    RepositoryImplementation.prototype.loadManyToOneForManyRows = function (rawRows, loadOptions, loader) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            var loadFields, _c, _d, col, ei, isRelation, load, repo, toLoad, rawRows_1, rawRows_1_1, r, val, rel, e_8_1, result, _loop_1, this_1, _e, _f, col;
            var e_8, _g, e_9, _h, e_10, _j;
            var _this = this;
            return tslib_1.__generator(this, function (_k) {
                switch (_k.label) {
                    ...
                    case 1:
                        ...
                        _c = tslib_1.__values(this.metadata.fields), _d = _c.next();
                        _k.label = 2;
                    case 2:
                        if (!!_d.done) return [3 /*break*/, 7];
                        col = _d.value;
                        ei = (0, getEntityRef_js_1.getEntitySettings)(col.valueType, false);
                        if (!ei) return [3 /*break*/, 5];
                        isRelation = (_a = col.options) === null || _a === void 0 ? void 0 : _a[relationInfoMember_js_1.relationInfoMember];
                        ...
                        try {
                            ...
                            try {
                                if (rawRows_1_1 && !rawRows_1_1.done && (_h = rawRows_1.return)) _h.call(rawRows_1);
                            }
                    ...
                    case 5:
                        if (col.options[relationInfoMember_js_1.relationInfoMember]) {
                            rel = col.options[relationInfoMember_js_1.relationInfoMember];
                    ...
                    case 9:
                        ...
                        return [7 /*endfinally*/];
                    case 10: return [4 /*yield*/, Promise.all(rawRows.map(function (r) { return tslib_1.__awaiter(_this, void 0, void 0, function () { return tslib_1.__generator(this, function (_a) {
                            switch (_a.label) {
                    ...
                    case 11:
                        ...
                        _loop_1 = function (col) {
                            var e_12, _l;
                            var rel = (0, relationInfoMember_js_1.getRelationInfo)(col.options);
                            var incl = col.options
                                .defaultIncluded;
                            if (((_b = loadOptions === null || loadOptions === void 0 ? void 0 : loadOptions.include) === null || _b === void 0 ? void 0 : _b[col.key]) !== undefined) {
                                incl = loadOptions.include[col.key];
                            }
                            if (rel && incl) {
                                var otherRepo = this_1.remult.repo(rel.toType());
                                var _loop_2 = function (row) {
                                    var _m = this_1.findOptionsBasedOnRelation(rel, col, incl, row, otherRepo), findOptions = _m.findOptions, returnNull = _m.returnNull;
                                    if (returnNull)
                                        row[col.key] = null;
                                    else {
                                        var entityType = rel.toType();
                                        var toRepo_1 = this_1.remult.repo(entityType);
                                        loader
                                            .load({
                                ...
                                try {
                                    ...
                                    try {
                                        if (result_1_1 && !result_1_1.done && (_l = result_1.return)) _l.call(result_1);
                                    }
                        ...
                        this_1 = this;
                        try {
                            for (_e = tslib_1.__values(this.metadata.fields), _f = _e.next(); !_f.done; _f = _e.next()) {
                                col = _f.value;
                                _loop_1(col);
                            }
                        }
    ...
    RepositoryImplementation.prototype.findOptionsBasedOnRelation = function (rel, field, moreFindOptions, row, otherRepo) {
        var e_13, _a, e_14, _b, e_15, _c, _d, _e;
        ...
        try {
            for (var findOptionsSources_1 = tslib_1.__values(findOptionsSources), findOptionsSources_1_1 = findOptionsSources_1.next(); !findOptionsSources_1_1.done; findOptionsSources_1_1 = findOptionsSources_1.next()) {
                ...
                try {
                    for (var _f = (e_14 = void 0, tslib_1.__values([
                        'limit',
                        'include',
                        'orderBy',
        ...
        function buildError(what) {
            return Error("Error for relation: \"".concat(field.key, "\" to \"").concat(otherRepo.metadata.key, "\": ") +
                what);
        }
        var hasFields = function () { return options.field || options.fields; };
        if (rel.type === 'toMany' && !hasFields()) {
            try {
                for (var _h = tslib_1.__values(otherRepo.fields.toArray()), _j = _h.next(); !_j.done; _j = _h.next()) {
                    var fieldInOtherRepo = _j.value;
                    if (!hasFields()) {
                        var reverseRel = (0, relationInfoMember_js_1.getRelationInfo)(fieldInOtherRepo.options);
                        var relOp = fieldInOtherRepo.options;
                        if (reverseRel)
                            if (reverseRel.toType() === this.entity)
                                if (reverseRel.type === 'reference') {
                                    options = tslib_1.__assign(tslib_1.__assign({}, findOptions), { field: fieldInOtherRepo.key });
                                }
                                else if (reverseRel.type === 'toOne') {
                                    if (relOp.field) {
                                        options = tslib_1.__assign(tslib_1.__assign({}, options), { field: relOp.field });
                                    }
                                        ...
                                        options = tslib_1.__assign(tslib_1.__assign({}, options), { fields: fields });
                                    }
                                }
                    }
                }
        ...
        if (options.field) {
            if (rel.type === 'toOne') {
                requireField(options.field, this.metadata);
                ...
                requireField(options.field, otherRepo.metadata);
                where.push((_d = {},
                    _d[options.field] = this.metadata.idMetadata.getId(row),
                    _d));
            }
        }
            ...
            for (var key in options.fields) {
                if (Object.prototype.hasOwnProperty.call(options.fields, key)) {
                    ...
                    where.push((_e = {}, _e[key] = row[options.fields[key]], _e));
                }
            }
        }
        else if (rel.type === 'toOne' || rel.type === 'reference') {
            var val = rel.type === 'reference'
                ? (0, getEntityRef_js_1.getEntityRef)(row).fields.find(requireField(field.key, this.metadata)).getId()
                : row[field.key];
            if (!field.allowNull && (val === 0 || val === ''))
                val = null;
            if (val === null)
                returnNull = true;
            if (val === undefined)
                ...
                where.push(otherRepo.metadata.idMetadata.getIdFilter(otherRepo.metadata.idMetadata.getId(val)));
            else
                where.push(otherRepo.metadata.idMetadata.getIdFilter(val));
        }
                    ...
                    for (_a = tslib_1.__values(this.fieldsOf(item)), _b = _a.next(); !_b.done; _b = _a.next()) {
                        ...
                        if (val !== null && val !== undefined) {
                            if (field.valueType === Date && !(val instanceof Date))
                                ...
                                try {
                                    for (_c = (e_19 = void 0, tslib_1.__values([
                                        [String, 'string'],
                                        [Number, 'number'],
                                        [Boolean, 'boolean'],
...
exports.columnsOfType = new Map();
function createOldEntity(entity, remult) {
    var _this = this;
    var r = exports.columnsOfType.get(entity);
    if (!r)
        exports.columnsOfType.set(entity, (r = []));
    ...
    var _loop_3 = function () {
        var e_20, _a;
        var baseCols = exports.columnsOfType.get(base);
        if (baseCols) {
        ...
        if (baseSettingsFactory) {
            ...
            try {
                for (var _b = (e_20 = void 0, tslib_1.__values(functions)), _c = _b.next(); !_c.done; _c = _b.next()) {
                    var key_1 = _c.value;
                    _loop_4(key_1);
                }
            }
...
var rowHelperBase = /** @class */ (function () {
    function rowHelperBase(fieldsMetadata, instance, remult, isNewRow) {
        ...
        var _loop_5 = function (col) {
            var ei = (0, getEntityRef_js_1.getEntitySettings)(col.valueType, false);
            if (ei && remult) {
                var lookup_1 = new column_js_1.LookupColumn(remult.repo(col.valueType), Boolean((0, relationInfoMember_js_1.getRelationInfo)(col.options)), col.allowNull);
            ...
            else if (((_b = (0, relationInfoMember_js_1.getRelationInfo)(col.options)) === null || _b === void 0 ? void 0 : _b.type) === 'toOne') {
                ...
                Object.defineProperty(instance, col.key, {
                    ...
                    set: function (newVal) {
                        ...
                        var op = col.options;
                        if (op.field) {
                            _this.instance[op.field] = _this.remult
                                .repo((0, relationInfoMember_js_1.getRelationInfo)(col.options).toType())
                        ...
                        if (op.fields) {
                            for (var key in op.fields) {
                                if (Object.prototype.hasOwnProperty.call(op.fields, key)) {
                                    ...
                                    _this.instance[element] = newVal[key];
                                }
                            }
                        }
                    },
        ...
        try {
            for (var _b = tslib_1.__values(this.fieldsMetadata), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if (rel &&
                    ...
                    if (this.remult.repo(rel.toType()).metadata.idMetadata.field.valueType ===
                        Number)
                        val = 0;
                    else
                        val = '';
            ...
            for (var _b = tslib_1.__values(this.fieldsMetadata), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if (notJustApi || !this.remult || col.includedInApi(this.instance)) {
                    ...
                    if (lu)
                        ...
                        if ((0, relationInfoMember_js_1.getRelationInfo)(col.options) && !includeRelatedEntities) {
                            disable = true;
                        }
                        else {
                            val = this.instance[col.key];
...
var rowHelperImplementation = /** @class */ (function (_super) {
    ...
    rowHelperImplementation.prototype.save = function (onlyTheseFieldsSentOnlyInTheCaseOfProxySaveWithPartialObject) {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var doNotSave_1, e, _b, _c, col, e_30_1, d, ignoreKeys, _d, _e, field, f, updatedRow, isNew, changesOnly, wasChanged, key, element, _f, _g, listener, e_31_1, err_1;
            var e_30, _h, e_32, _j, e_31, _k;
    ...
    rowHelperImplementation.prototype.delete = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var e, _a, _b, listener, e_33_1, err_2;
            var e_33, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
            ...
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        if (!(!col.options.lazy && !col.options[relationInfoMember_js_1.relationInfoMember])) return [3 /*break*/, 3];
                    ...
                    case 7:
                        if (!(0, relationInfoMember_js_1.getRelationInfo)(col.options))
    ...
    rowHelperImplementation.prototype.wasChanged = function () {
        ...
        try {
            for (var _c = tslib_1.__values(this.fields), _d = _c.next(); !_d.done; _d = _c.next()) {
                var col = _d.value;
                var rel = (0, relationInfoMember_js_1.getRelationInfo)(col.metadata.options);
                if (!rel || rel.type == 'reference')
                    if (col.valueChanged())
                        return true;
            }
    ...
    rowHelperImplementation.prototype.__performColumnAndEntityValidations = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, _b, c, col, e_37_1, e, _c, _d, listener, e_38_1;
            var e_37, _e, e_38, _f;
...
function getControllerRef(container, remultArg) {
    ...
    if (!result) {
        var columnSettings_1 = exports.columnsOfType.get(container.constructor);
        if (!columnSettings_1)
            exports.columnsOfType.set(container.constructor, (columnSettings_1 = []));
...
var FieldRefImplementation = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        rel = (0, relationInfoMember_js_1.getRelationInfo)(this.metadata.options);
    ...
    FieldRefImplementation.prototype.__performValidation = function () {
        var _a;
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var processValidation, self_1, event_1, _b, _c, v, _d, e_41_1, _e, error_1;
            var e_41, _f;
            var _this = this;
            return tslib_1.__generator(this, function (_g) {
                switch (_g.label) {
