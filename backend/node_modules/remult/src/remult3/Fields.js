...
var Fields = /** @class */ (function () {
    ...
    Fields.number = function () {
        ...
        return Field.apply(void 0, tslib_1.__spreadArray([function () { return Number; }], tslib_1.__read(options), false));
    };
...
var Relations = /** @class */ (function () {
    ...
    Relations.toOne = function (toEntityType, options) {
        ...
        if (!op.field && !op.fields && !op.findOptions)
            //@ts-ignore
            return Field(toEntityType, tslib_1.__assign(tslib_1.__assign({}, op), (_a = {}, _a[relationInfoMember_js_1.relationInfoMember] = {
                //field,
                toType: toEntityType,
                type: 'reference',
            }, _a)));
        return Field(function () { return undefined; }, tslib_1.__assign(tslib_1.__assign({}, op), (_b = { serverExpression: function () { return undefined; } }, _b[relationInfoMember_js_1.relationInfoMember] = {
            //field,
            toType: toEntityType,
            type: 'toOne',
        }, _b)));
    ...
    Relations.toMany = function (toEntityType, options) {
        ...
        var op = (typeof options === 'string'
            ? { field: options }
            : options);
        return Field(function () { return undefined; }, tslib_1.__assign(tslib_1.__assign({}, op), (_a = { serverExpression: function () { return undefined; } }, _a[relationInfoMember_js_1.relationInfoMember] = {
            //field,
            toType: toEntityType,
            type: 'toMany',
        }, _a)));
...
function Field(valueType) {
    ...
    return function (target, context, c) {
        ...
        var factory = function (remult) {
            ...
            if (r.required) {
                r.validate = addValidator(r.validate, validators_js_1.Validators.required);
            }
            if (r.maxLength) {
                r.validate = addValidator(r.validate, validators_js_1.Validators.maxLength(r.maxLength));
            }
        ...
        checkTarget(target);
        var names = RepositoryImplementation_js_1.columnsOfType.get(target.constructor);
        if (!names) {
            names = [];
            RepositoryImplementation_js_1.columnsOfType.set(target.constructor, names);
        }
