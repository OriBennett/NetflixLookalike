...
import type { ControllerRef, ControllerRefForControllerBase, EntityFilter, EntityMetadata, EntityOrderBy, EntityRef, EntityRefForEntityBase, FieldRef, FieldsMetadata, FieldsRef, FieldsRefForEntityBase, FindFirstOptions, FindFirstOptionsBase, FindOptions, IdMetadata, LiveQuery, LoadOptions, MembersOnly, QueryOptions, QueryResult, Repository, RepositoryRelations, Subscribable } from './remult3.js';
import type { RefSubscriber } from './remult3.js';
import type { entityEventListener } from '../__EntityValueProvider.js';
import type { DataProvider, EntityDataProvider, EntityDataProviderFindOptions, ErrorInfo } from '../data-interfaces.js';
...
export declare class RepositoryImplementation<entityType> implements Repository<entityType> {
    ...
    update(id: entityType extends {
        ...
        id?: string;
    } ? string : string | number, item: Partial<MembersOnly<entityType>>): Promise<entityType>;
...
declare abstract class rowHelperBase<T> {
    ...
    constructor(fieldsMetadata: FieldMetadata[], instance: T, remult: Remult, isNewRow: boolean);
...
export declare function buildCaption(caption: string | ((remult: Remult) => string), key: string, remult: Remult, metaData: EntityMetadata<any>): string;
