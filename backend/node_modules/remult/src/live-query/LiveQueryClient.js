    ...
    LiveQueryClient.prototype.openIfNoOpened = function () {
        ...
        if (!this.client) {
            this.interval = setInterval(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var ids, _a, _b, q, p_1, actionInfo, invalidIds, _c, invalidIds_1, invalidIds_1_1, id, _d, _e, q;
                ...
                return tslib_1.__generator(this, function (_j) {
                    switch (_j.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.resolve().then(function () { return tslib_1.__importStar(require('../server-action-info.js')); })];
                        case 1:
                            actionInfo = (_j.sent()).actionInfo;
                            _c = this.runPromise;
                            return [4 /*yield*/, actionInfo.runActionWithoutBlockingUI(function () {
                        ...
                        case 2: return [4 /*yield*/, _c.apply(this, [_j.sent()])];
                        case 3:
                            invalidIds = _j.sent();
                            try {
