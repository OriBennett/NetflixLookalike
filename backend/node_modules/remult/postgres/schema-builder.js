...
exports.PostgresSchemaBuilder = exports.verifyStructureOfAllEntities = exports.postgresColumnSyntax = void 0;
...
function verifyStructureOfAllEntities(db, remult) {
    return tslib_1.__awaiter(this, void 0, void 0, function () {
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, new PostgresSchemaBuilder(db).verifyStructureOfAllEntities(remult)];
...
var PostgresSchemaBuilder = /** @class */ (function () {
    ...
    PostgresSchemaBuilder.prototype.verifyStructureOfAllEntities = function (remult) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var completed, entities, _a, _b, entityClass, entity, e, e_1_1;
            var e_1, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        _a = tslib_1.__values(tslib_1.__spreadArray([], tslib_1.__read(context_js_1.allEntities), false).reverse()), _b = _a.next();
                        _d.label = 2;
                    case 2:
                        if (!!_b.done) return [3 /*break*/, 5];
                        entityClass = _b.value;
                        entity = remult.repo(entityClass).metadata;
                    ...
                    case 7:
                        ...
                        return [7 /*endfinally*/];
                    case 8: return [4 /*yield*/, this.ensureSchema(entities)];
                    case 9:
                        _d.sent();
                        return [2 /*return*/];
                }
    ...
    PostgresSchemaBuilder.prototype.ensureSchema = function (entities) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var entities_1, entities_1_1, entity, e, err_1, e_2_1;
            var e_2, _a;
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        colName = e.$dbNameOf(c(entity));
                        return [4 /*yield*/, cmd.execute("SELECT 1 FROM information_schema.columns WHERE " +
    ...
    PostgresSchemaBuilder.prototype.verifyAllColumns = function (entity) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var cmd, e, cols, _a, _b, col, colName, sql, e_4_1, err_3;
            var e_4, _c;
            return tslib_1.__generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
