...
function remultGraphql(options) {
    ...
    if (!options.getRemultFromRequest) {
        options.getRemultFromRequest = function () { return index_js_1.remult; };
    }
    ...
    try {
        ...
        for (var _h = tslib_1.__values(['String', 'Int', 'Float', 'Boolean', 'ID']), _j = _h.next(); !_j.done; _j = _h.next()) {
            var whereType = _j.value;
            ...
            try {
                for (var _k = (e_2 = void 0, tslib_1.__values(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(operatorType), false), tslib_1.__read(operatorTypeArray), false))), _l = _k.next(); !_l.done; _l = _k.next()) {
            ...
            if (whereType === 'String' ||
                ...
                whereType === 'Float') {
                try {
                    for (var _m = (e_3 = void 0, tslib_1.__values(['gt', 'gte', 'lt', 'lte'])), _o = _m.next(); !_o.done; _o = _m.next()) {
            ...
            if (whereType === 'String') {
                try {
                    for (var _p = (e_4 = void 0, tslib_1.__values(['contains', 'notContains'])), _q = _p.next(); !_q.done; _q = _p.next()) {
                        var operator = _q.value;
                        var field = {
                            key: operator,
                            value: whereType,
                        };
    ...
    var _loop_1 = function (meta) {
        ...
        if (key) {
            ...
            var handleRequestWithDataApiContext_1 = function (work) {
                return createResultPromise_1(function (response, setResult, arg1, req) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    ...
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                remult = options.getRemultFromRequest(req);
            ...
            var handleMutationWithErrors = function (work) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, dApi.get(tslib_1.__assign(tslib_1.__assign({}, response), { success: function (y) {
                                    currentType.query.resultProcessors.forEach(function (z) { return z(y); });
                                    setResult(y);
                                } }), arg1.id)];
                        case 1:
                            _a.sent();
            ...
            root[key] = handleRequestWithDataApiContext_1(function (dApi, response, setResult, arg1, meta) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                ...
                return tslib_1.__generator(this, function (_b) {
                    setResult((_a = {},
                        _a[itemsKey_1] = createResultPromise_1(function (response, setResult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                        ...
                        _a[totalCountKey_1] = createResultPromise_1(function (response, setResult) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
            ...
            if (checkCanExist(meta.options.allowApiInsert)) {
                ...
                root[createResolverKey_1] = handleMutationWithErrors(function (dApi, response, setResult, arg1, req) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
            ...
            if (checkCanExist(meta.options.allowApiUpdate)) {
                ...
                var updateResolverKey_1 = "update".concat(getMetaType(meta));
                root_mutation.fields.push({
                    key: updateResolverKey_1,
                    args: [
                        argId,
                ...
                root[updateResolverKey_1] = handleMutationWithErrors(function (dApi, response, setResult, arg1, req) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                ...
                resolversMutation[updateResolverKey_1] = function (origItem, args, req, gqlInfo) { return root[updateResolverKey_1](args, req, gqlInfo); };
            }
            if (checkCanExist(meta.options.allowApiDelete)) {
                // delete
                var deletePayload = "Delete".concat(getMetaType(meta), "Payload");
                var deleteResolverKey_1 = "delete".concat(getMetaType(meta));
                root_mutation.fields.push({
                    key: deleteResolverKey_1,
                ...
                root[deleteResolverKey_1] = handleMutationWithErrors(function (dApi, response, setResult, arg1, req) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                    return tslib_1.__generator(this, function (_a) {
                        switch (_a.label) {
                ...
                resolversMutation[deleteResolverKey_1] = function (origItem, args, req, gqlInfo) { return root[deleteResolverKey_1](args, req, gqlInfo); };
            }
            var whereTypeFields = [];
            var _loop_2 = function (f) {
                var ri = (0, internals_js_1.getRelationInfo)(f.options);
                // let's not consider toMany relations for now
                if ((ri === null || ri === void 0 ? void 0 : ri.type) === 'toMany') {
                    return "break";
                }
                ...
                switch (f.valueType) {
                    ...
                    case Number:
                        {
                            if (((_f = f.valueConverter) === null || _f === void 0 ? void 0 : _f.fieldTypeInDb) === 'integer' ||
                                ((_g = f.valueConverter) === null || _g === void 0 ? void 0 : _g.fieldTypeInDb) === 'autoincrement')
                                type = 'Int';
                            else
                                type = 'Float';
                        }
                ...
                var includeInUpdateOrInsert = f.options.allowApiUpdate !== false;
            ...
            try {
                for (var _s = (e_6 = void 0, tslib_1.__values(meta.fields)), _t = _s.next(); !_t.done; _t = _s.next()) {
                    var f = _t.value;
                    var state_1 = _loop_2(f);
                    if (state_1 === "break")
                        break;
                }
            }
